...
def calculer_tarif():
    ...
    st.write("---")
    st.subheader("Réductions liées à l'usage de la chirouze")
    ...
    with col_c:
        st.write("Service rendu")
        st.caption("Ménage saisonnier, jardinage, travaux, vidange... ou autre contribution en nature")
